...
const ReactNavbar = ({
  ...
  link3Url = "/text3",
  link4Url = "/text4",
  // Add link5Text and link5Url with their default values
  link5Text = "Text 5",
  link5Url = "/text5",
}) => {
  ...
  const link5 = useRef(null); // Ref for link5
  ...
  useEffect(() => {
    ...
    link5.current.addEventListener("mouseover", () => { // Event listeners for link5
        ...
        <div className="nav2">
          ...
          <Link
            ...
            style={{
              ...
              border: link5Border,
              transition: `all ${link5Transition}s`,
              animation: menuToggle
                ? `LinkIn ${link5AnimationTime}s`
                : `LinkOut ${link5AnimationTime}s`,
            }}
            to={link5Url}
            onClick={closeBarOnClick}
          >
