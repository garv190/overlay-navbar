...
const ReactNavbar = _ref => {
  let {
    ...
    // nav5Transition = nav4Transition + 0.4,    //
    link1Text = "Text 1",
    link2Text = "Text 2",
    link3Text = "Text 3",
    link4Text = "Text 4",
    ...
    link5AnimationTime = link4AnimationTime + 0.5,       //
    searchIcon = false,
    SearchIconElement,
    searchIconMargin = "0",
  ...
  const link5 = (0, _react.useRef)(null);
  ...
  (0, _react.useEffect)(() => {
    ...
    link5.current.addEventListener("mouseover", () => {
      link5.current.style.color = link5ColorHover;                          //
    }); 
    link5.current.addEventListener("mouseleave", () => {
      link5.current.style.color = link5Color;
    });
  ...
  link3Text), /*#__PURE__*/_react.default.createElement(_reactRouterDom.Link, {
    ...
    // link3Text},), /*#__PURE__*/_react.default.createElement("div", {
    }, link3Text)), /*#__PURE__*/_react.default.createElement("div", {
    ...
    to: link4Url,
    onClick: closeBarOnClick   //
  }, link4Text), /*#__PURE__*/_react.default.createElement(_reactRouterDom.Link, {
    className: "linksReactNavbar",
    ref: link5,
    style: {
      fontSize: link5Size,
      fontFamily: link5Family,
      color: link5Color,
      backgroundColor: link5BackgroundColor,
      textDecoration: link5Decoration,
      margin: link5Margin,
      padding: link5Padding,
      border: link5Border,
      transition: "all ".concat(link5Transition, "s"),
      animation: menuToggle ? "LinkIn ".concat(link5AnimationTime, "s") : "LinkOut ".concat(link5AnimationTime, "s")
    },
    to: link5Url,
    onClick: closeBarOnClick       
  }, link5Text)), /*#__PURE__*/_react.default.createElement("div", {
    className: "nav4",
    style: {
      transform: menuToggle ? "translateY(0)" : "translateY(-100vmax)",
